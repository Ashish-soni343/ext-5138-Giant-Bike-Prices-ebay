...
class EbayAustraliaSpider(CrawlSpider):
    name = 'ebay_australia'
    ...
    start_urls = ["https://www.ebay.com.au/sch/i.html?_from=R40&_nkw=Giant+bike&_sacat=0&_ipg=240&_sop=10"]
    ...
    def parse_element_detail(self, response):          # Function to extract data from fetched urls
        ...
        key_value = ["Condition:", "Model Year:", "Shifter Style:", "Handlebar Type:", "Number of Speeds:", "Colour:", "Wheel Size:", "Suspension Type:", "Bike Type:", "Brand:",
                        "Frame Size:", "Material:", "Department:", "Model:", "Brake Type:", "Tyre Type:", "MPN:", "Vintage", "Gear Change Mechanism", "UPC", "Frame Number",
