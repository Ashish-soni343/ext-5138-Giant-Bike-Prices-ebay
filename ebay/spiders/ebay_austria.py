...
class EbayAustriaSpider(CrawlSpider):
    name = 'ebay_austria'
    ...
    start_urls = ["https://www.ebay.at/sch/i.html?_from=R40&_nkw=Giant+bike&_sacat=0&_ipg=240&_sop=10"]
            ...
            for (j, k) in zip(key_value, key_value_lang):
                ...
                try:
                    if "Model Year" in specification_u[i]:
                        ...
                        item["Age"] = (current_year) - int(specification_u[i + 1])
                except:
                    item["Age"] = ""
