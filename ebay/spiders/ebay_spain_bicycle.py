...
class EbaySpainBicycleSpider(CrawlSpider):
    ...
    start_urls = ["https://www.ebay.es/sch/177831/i.html?_from=R40&_nkw=giant+bicicletas&LH_TitleDesc=0&_sop=10&_ipg=60&_pgn=1"]
    ...
    def parse_element_detail(self, response):          # Function to extract data from fetched urls
        ...
        key_value_lang = ["Condition:", "Model Year:", "Shifter Style:", "Handlebar Type:", "Numero di cambi:", "Colore principale:",
                     "Dimensioni ruota:", "Suspension Type:", "Tipo:", "Marca:", "Frame Size:", "Materiale telaio:", "Department:", "Model:", "Tipo di freno:", "Tire Type:", "MPN:",
        ...
        for i in range(len(specification_u)-1):
            ...
            for (j, k) in zip(key_value, key_value_lang):
                ...
                if "Tamaño de la rueda:" in specification_u[i]:
