...
class EbayPolandBikeSpider(CrawlSpider):
    name = 'ebay_poland_bike'
    start_urls = ['https://www.ebay.pl/sch/177831/i.html?_from=R40&_nkw=giant+Rowery&LH_TitleDesc=0&_ipg=60&_sop=10&_pgn=1']
    ...
    def parse_element_detail(self, response):          # Function to extract data from fetched urls
        ...
        key_value_lang = ["Stan:", "Année De Fabrication:", "Shifter Style:", "Lenkerart:", "Nombre de vitesses:", "Farbe:", "Reifengröße:", "Federung:", "Fahrradart:", "Marque:",
                          "Rahmengröße:", "Matériau:", "Abteilung:", "Modell:", "Type de frein:", "Reifentyp:", "MPN:", "Vintage", "Gear Change Mechanism", "UPC", "Frame Number",
