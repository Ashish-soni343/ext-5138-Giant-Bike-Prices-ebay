...
class EbaySwitzerlandBikeSpider(CrawlSpider):
    ...
    start_urls = ['https://www.ebay.ch/sch/i.html?_from=R40&_nkw=giant+Fahrr%C3%A4der&_sacat=0&_sop=10&_ipg=60&_pgn=1']
    ...
    rules = (
        Rule(LinkExtractor(restrict_css='.pagination__next', deny=['_pgn=1', '_pgn=4'])),
    ...
    def parse_element_detail(self, response):          # Function to extract data from fetched urls
        ...
        key_value_lang = ["Condition:", "Modelljahr:", "Shifter Style:", "Handlebar Type:", "Number of Speeds:", "farbe:",
                     "Reifengröße:", "Suspension Type:", "Fahrradart:", "Marque:", "Rahmengröße:", "Cadre:", "Department:", "Modell:", "Brake Type:", "Tire Type:", "MPN:",
                     "Vintage", "Gear Change Mechanism", "UPC", "Frame Number", "Features", "Item Weight", "Stem", "Saddle", "Drivetrain Type", "Seatpost", "Genre", "Crankset",
        ...
        for i in range(len(specification_u)-1):
            for (j, k) in zip(key_value, key_value_lang):
                ...
                if "Marke:" in specification_u[i] or "Marca:" in specification_u[i]:
