...
class EbayAustriaBikeSpider(CrawlSpider):
    name = 'ebay_austria_bike'
    start_urls = ["https://www.ebay.at/sch/i.html?_from=R40&_nkw=Giant+Fahrr%C3%A4der&_sacat=0&_sop=10&_ipg=60&_pgn=1"]
    ...
    rules = (
        Rule(LinkExtractor(restrict_css='.pagination__next', deny=['_pgn=1', '_pgn=5'])),
    ...
    def parse_element_detail(self, response):          # Function to extract data from fetched urls
        ...
        key_value_lang = ["Zustand:", "Jahr:", "Shifter Style:", "Lenkerart:", "Number of Speeds:", "Farbe:", "Wheel Size:", "Federung:", "Fahrradart:", "Marke:",
                          "Rahmengröße:", "Material:", "Abteilung:", "Model:", "Bremsmethode:", "Reifentyp:", "MPN:", "Vintage", "Gear Change Mechanism", "UPC", "Frame Number",
                          "Features", "Item Weight", "Stem", "Saddle", "Drivetrain Type", "Seatpost", "Geschlecht", "Crankset", "Chainrings", "Cassette", "Wheel Set",
                          "Front Derailleur", "Fork", "Rear Derailleur", "Shifters"]
        key_value_lang_2 = ["Zustand:", "Jahr:", "Shifter Style:", "Lenkerart:", "Numero di cambi:", "Colore principale:", "Dimensioni ruota:", "Federung:", "Tipo:", "Marca:",
                          "Rahmengröße:", "Materiale telaio", "Abteilung:", "Model:", "Tipo di freno:", "Reifentyp:", "MPN:", "Vintage", "Gear Change Mechanism", "UPC", "Frame Number",
                          "Features", "Item Weight", "Stem", "Saddle", "Drivetrain Type", "Seatpost", "Geschlecht", "Crankset", "Chainrings", "Cassette", "Wheel Set",
                          "Front Derailleur", "Fork", "Rear Derailleur", "Shifters"]
        ...
        for i in range(len(specification_u)-1):
            for (j, k, q) in zip(key_value, key_value_lang, key_value_lang_2):
                if ":" in specification_u[i + 1] and i >= 3:
                    break

                if k in specification_u[i] or j in specification_u[i] or q in specification_u[i]:
