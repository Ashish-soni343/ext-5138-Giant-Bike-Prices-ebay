...
class EbayNetherlandBicycleSpider(CrawlSpider):
    name = 'ebay_netherland_bicycle'
    start_urls = ['https://www.ebay.nl/sch/177831/i.html?_from=R40&_nkw=giant+Fietsen&_sop=10&_ipg=60']
    ...
    rules = (
        Rule(LinkExtractor(restrict_css='.pagination__next', deny=['_pgn=1','rt=nc','_pgn=5'])),
