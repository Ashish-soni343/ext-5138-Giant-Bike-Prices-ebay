...
class EbayBelgiumBicycleSpider(CrawlSpider):
    name = 'ebay_belgium_bicycle'
    start_urls = ['https://www.benl.ebay.be/sch/177831/i.html?_from=R40&_nkw=giant+Fietsen&LH_TitleDesc=0&_ipg=60&_sop=10']

    # Mandatory data
    # AEID_project_id = ''
    type = "Bike"
    site = 'www.benl.ebay.be'
    ...
    def parse_element_detail(self, response):  # Function to extract data from fetched urls
        ...
        key_value_lang = ["Objectstaat:", "Jahr:", "Shifter Style:", "Lenkerart:", "Number of Speeds:", "Farbe:",
        ...
        key_value_lang_2 = ["Stan:", "Model Year:", "Shifter Style:", "Handlebar Type:", "Number of Speeds:", "Color:",
                     "Wheel Size:", "Federung:", "Bike Type:", "Marca:","Rahmengröße:", "Material:", "Abteilung:", "Modell:", "Brake Type:", "Tire Type:", "MPN:",
                     "Vintage", "Gear Change Mechanism", "UPC", "Frame Number","Features", "Item Weight", "Stem", "Saddle", "Drivetrain Type", "Seatpost", "Genere", "Crankset",
                     "Chainrings","Cassette", "Wheel Set", "Front Derailleur", "Fork", "Rear Derailleur", "Shifters"]
