...
class EbaySingaporeBicyclesSpider(CrawlSpider):
    name = 'ebay_singapore_bicycles'
    start_urls = ["https://www.ebay.com.sg/sch/i.html?_from=R40&_nkw=giant+bikes&_sacat=0&_ipg=60&_sop=10&_pgn=1"]
